...
export const libraryCategories: NavCategory[] = [
  { label: 'Dashboard', icon: LayoutDashboard, to: '/library', end: true, items: [] },
  { label: 'Books Catalog', icon: BookOpen, to: '/library/books', end: true, items: [] },
  { label: 'Categories', icon: FolderOpen, to: '/library/categories', end: true, items: [] },
  { label: 'Borrowings', icon: BookMarked, to: '/library/borrowings', end: true, items: [] },
  { label: 'Overdue', icon: AlertCircle, to: '/library/overdue', end: true, items: [] },
];
    ...
    <SidebarProvider>
      <Sidebar collapsible="icon">
        <SidebarHeader className="border-b px-4 py-3">
          <div className="flex items-center gap-2">
            ...
            <div className="flex flex-col group-data-[collapsible=icon]:hidden">
              <span className="text-sm font-semibold">SVHS Library</span>
              <span className="text-xs text-muted-foreground">Library Services</span>
            </div>
          </div>
        </SidebarHeader>
        ...
        >
          ...
          <ModuleSwitcher currentModule="/library" />
        </SidebarContent>
            ...
            <SidebarMenuItem>
              <DropdownMenu>
                ...
                <DropdownMenuContent side="top" align="start" className="w-56">
                  ...
                  <DropdownMenuSeparator />
                  <DropdownMenuItem onClick={() => navigate('/library/profile')}>
      ...
      <SidebarInset>
        <ImpersonationBanner />
        <SiteHeader />
        <SubNav categories={libraryCategories} />
